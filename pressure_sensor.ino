...
void loop() {
  //read from post, send to port 0
  //Read State from stm32
  ...
  // Serial.println("Getting pressure sensor data");
    sensor.read();
   // print_values();
    int depth = 0;
 ...
 /* for(int i=0;i < NUMPIXELS;i++){
        ...
        pixels.setPixelColor(i, pixels.Color(255,255,0)); // Moderately yellow color. 75 250 0 
